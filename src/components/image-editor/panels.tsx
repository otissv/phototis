...
export function ImageEditorPanels({ notify, className, ...props }: ImageEditorPanelsProps) {
    return <Tabs className={cn('lg:row-span-3 w-full rounded-sm', className)} defaultValue='layers' {...props}  >
